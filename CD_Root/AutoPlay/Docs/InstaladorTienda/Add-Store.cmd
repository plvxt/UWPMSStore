...
echo.
echo Instalando los servicios de compra
echo.
...
echo.
echo Instalando el instalador de paquetes
echo.
...
echo.
echo Instalando servicios de Xbox
echo.
...
:uac
echo.
echo Ejecuta el programa como administrador
echo.
echo.
...
:version
echo.
echo Este instalador sólo funciona en Windows 10 1709 y superior
echo.
echo.
echo Presiona cualquier tecla para salir.
pause >nul
...
:nofiles
echo.
echo Hay archivos faltantes, vuelve a descargar el software desde la página oficial
echo.
echo.
echo Presiona cualquier tecla para salir.
pause >nul
...
:fin
echo.
echo Terminado, actualiza manualmente la tienda.
echo.
echo Presiona cualquier tecla para salir.
pause >nul
exit
